...
const WorldTimelineAccess: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="p-6 max-w-screen-lg mx-auto text-center">
        <FormWrapper title="World Timelines" onSubmit={(e) => e.preventDefault()}>
          {worlds.length === 0 ? (
                ...
                {worlds.map((world) => (
                  <CardItem key={world._id}>
                    ...
                    <div className="mt-4 self-center">
                      <CommonButton
                        variant="primary"
                        onClick={() => navigate(`/timeline/world/${world._id}/`)}
                      >
                        View Timeline
                      </CommonButton>
                    </div>
...
export default WorldTimelineAccess;
